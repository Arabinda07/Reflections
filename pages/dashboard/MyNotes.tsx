                  ...
                  <div className="bezel-inner flex flex-col h-full !p-0">
                    <div className="relative h-44 w-full overflow-hidden border-b border-border">
                      ...
                      <button 
                        ...
                        className="absolute top-4 left-4 z-20 h-9 w-9 flex items-center justify-center rounded-xl bg-white/10 backdrop-blur-md border border-white/20 text-white hover:text-red hover:border-red/30 shadow-sm active:scale-95 transition-all duration-300"
                      >
                      ...
                      <div className="absolute top-4 right-4 z-20 flex flex-col items-end gap-2">
                           <div className="flex items-center gap-2 rounded-full bg-white/10 backdrop-blur-md border border-white/20 px-3 py-1 text-[11px] font-bold text-white shadow-sm">
                              <div className="flex items-center gap-1.5 border-r border-white/20 pr-2 mr-0.5">
