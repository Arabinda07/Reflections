        ...
        {sections.map((section) => (
          ...
          >
            <div className="shrink-0 md:w-1/3">
              <h2 className="flex items-center gap-2.5 text-[22px] font-display font-bold leading-tight text-gray-text transition-colors duration-300 group-hover:text-green">
                <PublicPageIcon
                  name={section.icon}
                  size={20}
            ...
            <div className="flex items-center md:w-2/3">
              <p className="max-w-[65ch] font-sans text-[16px] leading-relaxed text-gray-light">{section.body}</p>
            </div>
          </section>
        ))}
      </div>
