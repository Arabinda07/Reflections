        ...
        {isPlaying && (
          <div className="flex items-center pr-2">
            ...
            <button
              ...
              className="flex h-11 w-11 shrink-0 items-center justify-center text-gray-nav hover:text-clay hover:bg-clay/5 rounded-[var(--radius-control)] transition-all duration-300 ease-out-quart"
