...
export const Button: React.FC<ButtonProps> = ({ 
  ...
  const variants = {
    primary: "bg-green text-white shadow-3d-green liquid-glass",
    secondary: "bg-white/80 border-2 border-border text-blue shadow-3d-gray liquid-glass",
    ...
    danger: "bg-red text-white shadow-3d-red liquid-glass",
